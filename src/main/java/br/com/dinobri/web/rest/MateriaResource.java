...
/**
 * REST controller for managing {@link br.com.dinobri.domain.Materia}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class MateriaResource {
     ...
     */
    @GetMapping("/materias")
    public List<Materia> getAllMaterias(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all Materias");
        return materiaRepository.findAllWithEagerRelationships();
    }
    ...
    public ResponseEntity<Materia> getMateria(@PathVariable Long id) {
        ...
        Optional<Materia> materia = materiaRepository.findOneWithEagerRelationships(id);
